...
public:
	...
	void stepHighway(double egoVelocity, long long timestamp, int frame_per_sec, pcl::visualization::PCLVisualizer::Ptr& viewer)
	{
        ...
        //viewer->addText("NIS_Lidar" +std::to_string(ukf.NIS_laser), 30, 175, 20, 1, 1, 1, "NIS_Lidar");//added
		//viewer->addText("NIS_Radar" +std::to_string(ukf.NIS_radar), 30, 150, 20, 1, 1, 1, "NIS radar");//added
